...
//---------------------------------------------------------------------
      for (stage = 1; stage <= ncells; stage++) {
         c = slice(1,stage);
//      printf("UE %d passed slice.1(stage %0d)...\n", RCCE_ue(), stage);fflush(0);
//---------------------------------------------------------------------
...
//           printf("UE %d passed slice.2(stage %0d)...\n", RCCE_ue(), stage);fflush(0);
           x_sendrecv_solve(c, cprev);
//           printf("UE %d passed x_sendrecv_solve(stage %0d)...\n", RCCE_ue(), stage);fflush(0);
        }
        x_solve_cell(first,last,c);
//        printf("UE %d passed x_solve_cell(stage %0d)...\n", RCCE_ue(), stage);fflush(0);
      }
//      printf("UE %d passed \"set first/last-cell flags\"...\n", RCCE_ue());fflush(0);

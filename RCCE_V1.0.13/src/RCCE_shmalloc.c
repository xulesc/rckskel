...
//--------------------------------------------------------------------------------------
// FUNCTION: RCCE_shmalloc_request
//--------------------------------------------------------------------------------------
// this function tries to return a (padded) amount of space in shared memory of size 
// "size" bytes. If not enough space is available, the function keeps halving it until 
// it fits. Collective, see RCCE_shmalloc,
//--------------------------------------------------------------------------------------
t_vcharp RCCE_shmalloc_request(
